...
from fever_sampler import fever_p_level_sampler, fever_s_level_sampler
import json
...
if __name__ == '__main__':
    model_saved_path = config.PRO_ROOT / "saved_models/04-24-00:11:19_fever_v0_slevel_retri_(ignore_non_verifiable:True)/" \
                                         "i(30000)|e(1)|v01_ofever(0.9084908490849085)|v02_ofever(0.8892389238923892)|v05_ofever(0.8420342034203421)|seed(12)"  # baseline
    # eval_model_for_downstream(model_saved_path)
    # model_go()
    for kv in [100, 50, 20]:
        eval_model_for_downstream_ablation(model_saved_path, top_k_doc=kv)