...
from evaluation.confusion_matrix_analysis import report
...
def fever_sent_only(predictions, actual=None, max_evidence=5):
    '''
    This method is used to only evaluate document retrieval
    '''
    macro_precision = 0
...
def check_sent_correct(instance, actual, max_length=5):
    check_predicted_evidence_format(instance)
...
def fever_confusion_matrix(predictions, actual=None):
    label2id = {
        'SUPPORTS': 0,
        'REFUTES': 1,
        "NOT ENOUGH INFO": 2,
